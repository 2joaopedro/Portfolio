...
export default function Contato() {
  return (
    <div className="flex flex-col items-center mt-[7.5rem] w-full">
       ...
       <Link href="https://wa.me/5514982254049" className="flex justify-center items-center rounded-lg font-bold text-2xl mt-36 text-[#F0F0F0] bg-[#9071E9] hover:shadow-inner w-[12.4375rem] h-[5.5rem]">Fale Comigo</Link>
       <div className="flex  gap-14 justify-center items-center mt-32 text-[#E0E0E0] hover:[#CCCCCC]">
